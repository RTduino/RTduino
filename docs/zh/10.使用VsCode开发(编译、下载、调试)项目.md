# 使用VsCode开发(编译、下载、调试)项目

## 1. 环境搭建

- RT-Thread ENV V1.4.0+
- VsCode 软件
...
![](images/10.build_task.png)

![](images/10.build_task_res.png)

## 5. 下载工程至单片机

终端->运行任务->Download code to flash memory

![](images/10.download_task.png)

![](images/10.download_task_res.png)

也可以使用`Build and Download`任务一键编译下载

## 6. 调试工程

![](images/10.debug_project.png)
