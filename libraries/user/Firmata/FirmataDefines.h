...
// pin modes
#define FIRMATA_PIN_MODE_INPUT          firmata::FIRMATA_PIN_MODE_INPUT // same as INPUT defined in Arduino.h
#define FIRMATA_PIN_MODE_OUTPUT         firmata::FIRMATA_PIN_MODE_OUTPUT // same as OUTPUT defined in Arduino.h
#define FIRMATA_PIN_MODE_ANALOG         firmata::FIRMATA_PIN_MODE_ANALOG // analog pin in analogInput mode
#define FIRMATA_PIN_MODE_PWM            firmata::FIRMATA_PIN_MODE_PWM // digital pin in PWM output mode
#define FIRMATA_PIN_MODE_SERVO          firmata::FIRMATA_PIN_MODE_SERVO // digital pin in Servo output mode
#define FIRMATA_PIN_MODE_SHIFT          firmata::FIRMATA_PIN_MODE_SHIFT // shiftIn/shiftOut mode
#define FIRMATA_PIN_MODE_I2C            firmata::FIRMATA_PIN_MODE_I2C // pin included in I2C setup
#define FIRMATA_PIN_MODE_ONEWIRE        firmata::FIRMATA_PIN_MODE_ONEWIRE // pin configured for 1-wire
#define FIRMATA_PIN_MODE_STEPPER        firmata::FIRMATA_PIN_MODE_STEPPER // pin configured for stepper motor
#define FIRMATA_PIN_MODE_ENCODER        firmata::FIRMATA_PIN_MODE_ENCODER // pin configured for rotary encoders
#define FIRMATA_PIN_MODE_SERIAL         firmata::FIRMATA_PIN_MODE_SERIAL // pin configured for serial communication
#define FIRMATA_PIN_MODE_PULLUP         firmata::FIRMATA_PIN_MODE_PULLUP // enable internal pull-up resistor for pin
#define FIRMATA_PIN_MODE_IGNORE         firmata::FIRMATA_PIN_MODE_IGNORE // pin configured to be ignored by digitalWrite and capabilityResponse
#define FIRMATA_TOTAL_PIN_MODES         firmata::FIRMATA_TOTAL_PIN_MODES
