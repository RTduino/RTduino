...
// pin modes
static const int FIRMATA_PIN_MODE_INPUT =          0x00; // same as INPUT defined in Arduino.h
static const int FIRMATA_PIN_MODE_OUTPUT =         0x01; // same as OUTPUT defined in Arduino.h
static const int FIRMATA_PIN_MODE_ANALOG =         0x02; // analog pin in analogInput mode
static const int FIRMATA_PIN_MODE_PWM =            0x03; // digital pin in PWM output mode
static const int FIRMATA_PIN_MODE_SERVO =          0x04; // digital pin in Servo output mode
static const int FIRMATA_PIN_MODE_SHIFT =          0x05; // shiftIn/shiftOut mode
static const int FIRMATA_PIN_MODE_I2C =            0x06; // pin included in I2C setup
static const int FIRMATA_PIN_MODE_ONEWIRE =        0x07; // pin configured for 1-wire
static const int FIRMATA_PIN_MODE_STEPPER =        0x08; // pin configured for stepper motor
static const int FIRMATA_PIN_MODE_ENCODER =        0x09; // pin configured for rotary encoders
static const int FIRMATA_PIN_MODE_SERIAL =         0x0A; // pin configured for serial communication
static const int FIRMATA_PIN_MODE_PULLUP =         0x0B; // enable internal pull-up resistor for pin
static const int FIRMATA_PIN_MODE_IGNORE =         0x7F; // pin configured to be ignored by digitalWrite and capabilityResponse

static const int FIRMATA_TOTAL_PIN_MODES =         13;
