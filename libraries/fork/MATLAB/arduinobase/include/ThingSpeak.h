 ...
 * * <a href="http://www.arduino.cc/en/Main/ArduinoMKR1010">Arduino MKR1010</a>
...
//#define PRINT_HTTP
  ...
  #include <Client.h>
#else
  #error Only Arduino MKR1000, MKR1010, Yun, Uno/Mega/Due with either WiFi101 or Ethernet shield. ESP8266 also supported.
#endif
...
#define THINGSPEAK_PORT_NUMBER 80
    ...
    #define TS_USER_AGENT "tslib-arduino/1.3 (arduino mkrwifi1010)"
